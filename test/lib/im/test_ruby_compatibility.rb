...
class TestRubyCompatibility < LoaderTest
  # We decorate Kernel#require in lib/im/kernel.rb be able to trigger
  ...
  # Once a managed file is autoloaded, Im verifies the expected constant
  # has been defined and raises Im::NameError if not. This happens within
  ...
  # Im sets autoloads using absolute paths and string concatenation with
  ...
  # Im has to be called as soon as explicit namespaces are defined, to be
  # able to configure autoloads for their children before the class or module
  # body is interpreted. If explicit namespaces are found, Im sets a trace
  ...
  # in reopened namespaces. Im won't override them, but thanks to this
  ...
  # This allows Im to be thread-safe on regular file autoloads. Module
