...
class TestEagerLoadDir < LoaderTest
  ...
  test "raises Im::Error if the argument is not a directory" do
    with_setup do
      e = assert_raises(Im::Error) { loader.eager_load_dir(__FILE__) }
  ...
  test "raises if the argument is not managed by the loader" do
    with_setup do
      e = assert_raises(Im::Error) { loader.eager_load_dir(__dir__) }
